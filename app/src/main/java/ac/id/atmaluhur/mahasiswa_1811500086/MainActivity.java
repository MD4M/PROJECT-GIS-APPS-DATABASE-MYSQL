package ac.id.atmaluhur.mahasiswa_1811500086;
...
import ac.id.atmaluhur.mahasiswa_1811500086.ui.hospital.HospitalFragment;
import ac.id.atmaluhur.mahasiswa_1811500086.ui.restaurant.RestaurantFragment;
import ac.id.atmaluhur.mahasiswa_1811500086.ui.school.SchoolFragment;
import api.ApiClient;
import api.ApiService;
import api.Hospitals;
import api.Restorants;
...
public class MainActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void school(){
        ...
        Toast.makeText(MainActivity.this, "Letak Sekolah", Toast.LENGTH_LONG).show();
    }
    ...
    public String getUrl(double latitude, double longitude, String nearbyPlace){
        ...
        googlePlaceUrl.append("&key="+"AIzaSyBzktrWebpasAdwIK5ol6MVlA7PpT_Ca4w");
    ...
    private void getrestoranall(){
        final ProgressDialog dialog = new ProgressDialog(this);
        dialog.setMessage("Menampilkan data marker ..");
        dialog.show();

        Restorants api = ApiClient.getClient().create(Restorants.class);
        Call<ListLocationModel> call = api.getRestoall();
        call.enqueue(new Callback<ListLocationModel>() {
            @Override
            public void onResponse(Call<ListLocationModel> call, Response<ListLocationModel> response) {
                dialog.dismiss();
    ...
    private void gethospitalnall(){
        final ProgressDialog dialog = new ProgressDialog(this);
        dialog.setMessage("Menampilkan data marker ..");
        dialog.show();

        Hospitals api = ApiClient.getClient().create(Hospitals.class);
        Call<ListLocationModel> call = api.getHosall();
        call.enqueue(new Callback<ListLocationModel>() {
            @Override
            public void onResponse(Call<ListLocationModel> call, Response<ListLocationModel> response) {
                dialog.dismiss();
